 ...
 * element interface generated in the org.xmlsoap.schemas.wsdl.soap package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Fault_QNAME = new QName(
			"http://schemas.xmlsoap.org/wsdl/soap/", "fault");
	private final static QName _Headerfault_QNAME = new QName(
			"http://schemas.xmlsoap.org/wsdl/soap/", "headerfault");
	private final static QName _Binding_QNAME = new QName(
			"http://schemas.xmlsoap.org/wsdl/soap/", "binding");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.xmlsoap.schemas.wsdl.soap
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link TAddress }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<TAddress> createAddress(TAddress value) {
		return new JAXBElement<TAddress>(_Address_QNAME, TAddress.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link TOperation }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<TOperation> createOperation(TOperation value) {
		return new JAXBElement<TOperation>(_Operation_QNAME, TOperation.class,
				null, value);
	}
	...
	public JAXBElement<THeader> createHeader(THeader value) {
		return new JAXBElement<THeader>(_Header_QNAME, THeader.class, null,
				value);
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link THeaderFault }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<THeaderFault> createHeaderfault(THeaderFault value) {
		return new JAXBElement<THeaderFault>(_Headerfault_QNAME,
				THeaderFault.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link TBinding }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<TBinding> createBinding(TBinding value) {
		return new JAXBElement<TBinding>(_Binding_QNAME, TBinding.class, null,
				value);
	}
