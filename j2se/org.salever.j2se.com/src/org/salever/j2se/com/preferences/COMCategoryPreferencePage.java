...
public class COMCategoryPreferencePage extends FieldEditorPreferencePage
		implements IWorkbenchPreferencePage {

	public COMCategoryPreferencePage() {
		super(GRID);
		setPreferenceStore(ClientComPlugin.getDefault().getPreferenceStore());
		setDescription(Messages.COMCategoryPreferencePage_desc);
	}
