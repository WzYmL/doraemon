 ...
 * <ul>
 *   <li>{@link org.talend.jobs.impl.JobImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.jobs.impl.JobImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JobImpl extends EObjectImpl implements Job {
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectResolvingEList<Component>(Component.class, this, JobsPackage.JOB__COMPONENTS);
		}
		return components;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JobsPackage.JOB__NAME:
				return getName();
			case JobsPackage.JOB__COMPONENTS:
