...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>jobs</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class JobsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.jobs"));
				Component root = JobsFactory.eINSTANCE.createComponent();
