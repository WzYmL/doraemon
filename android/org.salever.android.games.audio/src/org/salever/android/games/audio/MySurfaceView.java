...
// 获取音频服务然后强转成一个音频管理器,后面方便用来控制音量大小用  
        am = (AudioManager) GameAudioActivity.instance  
        ...
        soundPoolMap.put(1, soundPool.load(GameAudioActivity.content,  
                R.raw.himi_ogg, 1));  
...
//load()方法的最后一个参数他标识优先考虑的声音。目前没有任何效果。使用了也只是对未来的兼容性价值。  
    ...
    public void surfaceCreated(SurfaceHolder holder) {  
         ...
         */  
    	GameAudioActivity.instance.setVolumeControlStream(AudioManager.STREAM_MUSIC);  
