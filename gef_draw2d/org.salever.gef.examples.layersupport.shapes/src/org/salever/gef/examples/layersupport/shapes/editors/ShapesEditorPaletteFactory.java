...
?*******************************************************************************/
package org.salever.gef.examples.layersupport.shapes.editors;
...
private static PaletteContainer createShapesDrawer() {
	...
	component = new CombinedTemplateCreationEntry(
			"Container",
			"Create a container shape", 
			Container.class,
			new SimpleFactory(Container.class), 
			ImageDescriptor.createFromFile(ShapesPlugin.class, "icons/container_16.gif"), 
			ImageDescriptor.createFromFile(ShapesPlugin.class, "icons/container_32.gif"));
	componentsDrawer.add(component);
