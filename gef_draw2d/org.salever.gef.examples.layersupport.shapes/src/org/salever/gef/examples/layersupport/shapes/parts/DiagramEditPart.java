...
import org.salever.gef.examples.layersupport.shapes.model.commands.ShapeCreateCommand;
import org.salever.gef.examples.layersupport.shapes.model.commands.ShapeSetConstraintCommand;
...
private static class ShapesXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	protected Command createChangeConstraintCommand(ChangeBoundsRequest request,
		...
		if ((child instanceof ShapeEditPart ||child instanceof ContainerEditPart) && constraint instanceof Rectangle) {
	...
	protected Command getCreateCommand(CreateRequest request) {
		...
		if (childClass == EllipticalShape.class || childClass == RectangularShape.class || childClass == Container.class) {
