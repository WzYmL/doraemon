 ...
 * 
 */
package org.salever.rcp.tools.topology_viewer.splitter;
...
public class MySplitter extends Composite {
	...
	public MySplitter(Composite parent, int style) {
	...
	public void layout(boolean changed) {
		...
		if (sashes.length > 0)
			sashes[0].setBounds(controls[0].getBounds().x
					+ controls[0].getBounds().width, area.y, getSashWidth(),
					area.height);
	}
