...
public class JustifyCenterAction extends Action implements Listener {
	...
	public JustifyCenterAction(HtmlComposer composer) {
		super(Messages.JustifyCenterAction_0, IAction.AS_CHECK_BOX);
		setImageDescriptor(ActionUtil.getImageDescriptor("images/justifycenter.gif")); //$NON-NLS-1$ //$NON-NLS-2$
