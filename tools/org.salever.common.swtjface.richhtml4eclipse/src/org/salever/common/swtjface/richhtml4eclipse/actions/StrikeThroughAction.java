...
public class StrikeThroughAction extends Action implements Listener {
	...
	public StrikeThroughAction(HtmlComposer composer) {
		super(Messages.StrikeThroughAction_0, IAction.AS_CHECK_BOX);
		setImageDescriptor(ActionUtil.getImageDescriptor("images/strikethrough.gif")); //$NON-NLS-1$ //$NON-NLS-2$
