...
import org.salever.common.swtjface.richhtml4eclipse.actions.DeleteColumnAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.DeleteRowAction;
...
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertColumnAfterAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertColumnBeforeAction;
...
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertEditTableAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertLayerAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertNonBreakingWhitespace;
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertRowAfterAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.InsertRowBeforeAction;
...
import org.salever.common.swtjface.richhtml4eclipse.actions.MakeLayerAbsoluteAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.MoveLayerBackwardAction;
import org.salever.common.swtjface.richhtml4eclipse.actions.MoveLayerForwardAction;
...
import org.salever.common.swtjface.richhtml4eclipse.actions.SetHtmlAction;
 ...
 * 
 */
public class HtmlEditComposite extends Composite {
	...
	public HtmlEditComposite(Composite parent, int style, String tinyMCEPath) {
		super(parent, style);
	...
	private void init() {
		...
		coolbar.addListener(SWT.Resize, new Listener() {
			public void handleEvent(Event event) {
				HtmlEditComposite.this.getShell().layout();
			}
		});
		...
		fontsizeCombo.setItems(new String[] { Messages.HtmlEditComposite_2, "1", "2", "3", "4", //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
		...
		manager.add(getHtmAction = new GetHtmlAction(composer, htmlText));
