...
public class RemoveFormatAction extends Action {
	...
	public RemoveFormatAction(HtmlComposer composer) {
		super(Messages.RemoveFormatAction_0, IAction.AS_PUSH_BUTTON);
		setImageDescriptor(ActionUtil.getImageDescriptor("images/removeformat.gif")); //$NON-NLS-1$ //$NON-NLS-2$
