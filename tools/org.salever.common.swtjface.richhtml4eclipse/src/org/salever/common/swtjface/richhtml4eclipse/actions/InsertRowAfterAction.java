...
public class InsertRowAfterAction extends Action implements Listener {
	...
	public InsertRowAfterAction(HtmlComposer composer) {
		super(Messages.InsertRowAfterAction_0, IAction.AS_PUSH_BUTTON);
		setImageDescriptor(ActionUtil.getImageDescriptor("images/table_insert_row_after.gif")); //$NON-NLS-1$ //$NON-NLS-2$
