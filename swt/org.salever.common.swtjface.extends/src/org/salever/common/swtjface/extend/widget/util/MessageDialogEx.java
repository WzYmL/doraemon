 ...
 * </p>
 */
public class MessageDialogEx extends IconAndMessageDialog {
	/**
	...
	public final static int QUESTION_WITH_SAVE = 7;

	public final static int QUESTION_WITH_SAVE_ID = 2;

	public final static String QUESTION_WITH_SAVE_LABEL = "另存为";
	 ...
	 */
	public MessageDialogEx(Shell parentShell, String dialogTitle,
	...
	public static boolean open(int kind, Shell parent, String title,
		...
		MessageDialogEx dialog = new MessageDialogEx(parent, title, null,
	...
	static String[] getButtonLabels(int kind) {
		...
		case QUESTION_WITH_SAVE: {
			dialogButtonLabels = new String[] { IDialogConstants.YES_LABEL,
					IDialogConstants.NO_LABEL, QUESTION_WITH_SAVE_LABEL };
			break;
		}
		default: {
	 ...
	 *         <code>false</code> otherwise
	 */
	public static int openQuestionWithSave(Shell parent, String title,
			String message) {
		MessageDialogEx dialog = new MessageDialogEx(parent, title, null,
				message, QUESTION_WITH_SAVE,
				getButtonLabels(QUESTION_WITH_SAVE), 0);
		int style = 0;
		style &= SWT.SHEET;
		dialog.setShellStyle(dialog.getShellStyle() | style);
		return dialog.open();
