 ...
 * </p>
 */
public class PwdStringFieldEditor extends FieldEditor {
	 ...
	 */
	public PwdStringFieldEditor(String name, String labelText, Composite parent) {
	 ...
	 *            the parent of the field editor's control
	 */
	public PwdStringFieldEditor(String name, String labelText, int width,
			Composite parent) {
