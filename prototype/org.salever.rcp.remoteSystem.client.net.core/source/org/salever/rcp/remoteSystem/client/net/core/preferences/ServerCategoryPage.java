...
public class ServerCategoryPage extends FieldEditorPreferencePage implements
		IWorkbenchPreferencePage {

	public ServerCategoryPage() {
		super(GRID);
		setPreferenceStore(NetCoreActivator.getDefault().getPreferenceStore());
		setDescription(Messages.ServerCategoryPage_Dataserver);
	}
