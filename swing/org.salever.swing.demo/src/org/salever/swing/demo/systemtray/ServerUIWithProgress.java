...
public class ServerUIWithProgress extends JFrame implements PropertyChangeListener {
	...
	class Task extends SwingWorker<Void, Void> {
		...
		public void done() {
			...
			ServerUIWithProgress.this.setTitle("服务器正在运行...");
		}
	}
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ServerUIWithProgress frame = new ServerUIWithProgress();
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if ("progress" == evt.getPropertyName()) {
			...
			outputText.append(String.format("Completed %d%% of task.\n",
					task.getProgress()));
		}
	}
